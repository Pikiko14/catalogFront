<template>
  <section class="row">
    ...
    <div
      ...
      :key="idx"
    >
      <q-card class="my-card shadow-1 round-10" v-if="type === 'catalog'">
        <q-img class="col" :src="`${apiUrl}${item.cover}`">
            ...
            <q-btn flat round color="primary" icon="more_horiz">
              ...
              <q-menu anchor="top right" self="top left" max-height="130px">
                <q-list>
                  <q-item
                    clickable
                    :to="`/dashboard/catalogs/pages/${item._id}?page=1&perPage=16`"
                  >
